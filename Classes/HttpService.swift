...
func postHttp () {
  ...
  print(soapMessage)
    ...
    func postFocusNear () {
        ...
        let url = URL(string: "http://admin:admin@\(Login.ip)/services/io.ion?action=ptz&source=videoinput_1&command=focus&subcommand=nearstart&speed=75")
        var theRequest = URLRequest(url: url! as URL)
    ...
    func postFocusFar () {
        ...
        let url = URL(string: "http://admin:admin@\(Login.ip)/services/io.ion?action=ptz&source=videoinput_1&command=focus&subcommand=farstart&speed=75")
        var theRequest = URLRequest(url: url! as URL)
    ...
    func postFocusStop () {
        ...
        let url = URL(string: "http://admin:admin@\(Login.ip)/services/io.ion?action=ptz&source=videoinput_1&command=focus&subcommand=farstop")
        var theRequest = URLRequest(url: url! as URL)
